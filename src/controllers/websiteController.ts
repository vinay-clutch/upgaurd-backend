...
<head>
  <meta charset="UTF-8">
  <title>Antigravtiven Report</title>
  <style>
...
<body>
  ...
  <h1>🛡️ Antigravtiven Report — ${website.url}</h1>
  ...
  <p style="margin-top:40px;color:#9ca3af;text-align:center">Generated by Antigravtiven • ${new Date().toDateString()}</p>
</body>
</html>`;
